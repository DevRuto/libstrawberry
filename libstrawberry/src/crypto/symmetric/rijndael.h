...
extern "C" {
	...
	SBAPI void sb_crypto_rijndael_encrypt(sb_crypto_rijndael_ctx_t *rijndael, uint8_t out[16], uint8_t in[16]);
	SBAPI void sb_crypto_rijndael_decrypt(sb_crypto_rijndael_ctx_t *rijndael, uint8_t out[16], uint8_t in[16]);
