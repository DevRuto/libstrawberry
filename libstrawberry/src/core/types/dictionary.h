...
extern "C" {
	...
	SBAPI void sb_dictionary_init(sb_dictionary_t *dictionary, size_t size);
	SBAPI void sb_dictionary_clear(sb_dictionary_t *dictionary);
	SBAPI sb_bool_t sb_dictionary_get_index(sb_dictionary_t *dictionary, const char *key, size_t *index);
